...
| [`docs/AGENT_HANDOFF.md`](docs/AGENT_HANDOFF.md) | Live state transfer between agents |
...
- **Claude CLI** — architecture, domain modelling, invariants, API contracts,
...
```
Claude: design → Codex: implement → Claude: review (P0–P3) → Codex: fix → verify → commit
```

No phase begins while a P0 or P1 finding is open in a phase it depends on.
Contract: [`prompt.md`](prompt.md) · [`CLAUDE.md`](CLAUDE.md) · [`AGENTS.md`](AGENTS.md)
