...
Codex does not author ADRs. If implementation shows one is wrong, Codex stops and
records the conflict in `docs/AGENT_HANDOFF.md` under `# Known Problems`.
...
**Status:** Accepted · Phase 1 · **Resolves the conflict Codex raised**
...
Correctly identified by Codex during implementation.
